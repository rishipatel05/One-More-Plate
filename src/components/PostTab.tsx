...
const PROC_STEPS = [
  ...
  ['Dispatching WhatsApp notifications…', 'Sending to 3 active volunteers'],
];

export default function PostTab() {
  const { addPost, showToast, updateStats } = useApp();
  ...
  const volName = skippedVol ? 'Sarah K.' : 'Alex M.';
      ...
      {state === 'result' && analysis && currentPost && (
        <>
          ...
          <div className="wa-wrap">
            <div className="wa-bar">
              ...
              <div>
                ...
                <div className="wa-dist">{volDist} miles away · online</div>
              </div>
            </div>
              ...
              {!confirmed ? (
                <div className="wa-btns">
                  ...
                  {!skippedVol
                    ...
                    : <div style={{ padding: '8px', fontSize: 11, color: '#999', fontFamily: 'Karla, sans-serif' }}>Sarah K. notified…</div>
                  }
                </div>
              ) : (
                <div className="wa-btns">
          ...
          <div className="timeline">
            ...
            <div className="t-row"><div className="t-dot done" /><div className="t-text done">Gemini structured post — dispatched to 3 volunteers</div></div>
            <div className="t-row">
